  ...
  return (
    <div className="prose">
      ...
      <ul>
        ...
        <li>
          <strong>📍 Destination Address:</strong> [Insert Destination Address]
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>Access:</strong> Ensure clear access to entrances, elevators,
          and arrange any required parking permits.
        </li>
        <li>
