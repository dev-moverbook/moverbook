...
import { useShowOnboardingLink } from "@/hooks/connectedAccounts";
import FieldDisplay from "@/components/shared/field/FieldDisplay";
import { useStripeDashboardLink } from "../../hooks/connectedAccounts";
...
const StripeContent: React.FC<StripeContentProps> = ({ connectedAccount }) => {
